...
<h5 class="card-header">Order       <a href="{{--{{route('order.pdf',$order->id)}}--}}" class=" btn btn-sm btn-primary shadow-sm float-right"><i class="fas fa-download fa-sm text-white-50"></i> Generate PDF</a>
  ...
  <div class="card-body">
    ...
    <table class="table table-striped table-hover">
      @php
                $delivery_charge=DB::table('shippings')->where('id',$order->shipping_id)->pluck('delivery_charge');
      @endphp
      <thead>
        <tr>
            <th>S.N.</th>
      ...
      <tbody>
        <tr>
           ...
           {{-- <td>@foreach($delivery_charge as $data) $ {{number_format($data,2)}} @endforeach</td>--}}
    ...
    {{--<tr>
                    ...
                    <tr>
                      @php
                                      $shipping_charge=DB::table('shippings')->where('id',$order->shipping_id)->pluck('delivery_charge');
