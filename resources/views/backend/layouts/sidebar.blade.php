<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  {{-- <li class="nav-item">
   ...
   <li class="nav-item">
    ...
    {{-- Coupon --}}
     <li class="nav-item">
        ...
        <div id="couponCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
   ...
   {{-- <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#sellerCollapse" aria-expanded="true" aria-controls="shippingCollapse">
            <i class="fas fa-users"></i>
          <span>Sellers managment</span>
        </a>
        <div id="sellerCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Shipping Options:</h6>
            <a class="collapse-item" href="{{route('seller.index')}}">All Sellers</a>
             {{-- <a class="collapse-item" href="{{route('seller.index')}}">Add Shipping</a> --}}
          </div>
        </div>
    </li>
