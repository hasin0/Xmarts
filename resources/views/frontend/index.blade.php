...
@if(count($banners)>0)
    <section id="Gslider" class="carousel slide" data-ride="carousel">
        ...
        <a class="carousel-control-next"  background-color="red" href="#Gslider" role="button" data-slide="next">
...
<section class="small-banner section">
    <div class="container-fluid">
        <div class="row">
           ...
           {{--<div class="col-lg-4 col-md-6 col-12">
                <div class="single-banner">
                    <img src="Frontends/images/mini-banner2.jpg" alt="#">
                    <div class="content">
                        <p>Bag Collectons</p>
            ...
            <div class="col-lg-4 col-12">
                <div class="single-banner tab-height">
                    <img src="Frontends/images/mini-banner3.jpg" alt="#">
                    <div class="content">
                        <p>Flash Sale</p>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="{{route('product.detail',$nproducts->slug)}}">
                                                    ...
                                                    <div class="button-head">
                                                        <div class="product-action">
                                                            ...
                                                            <a title="Wishlist" href="javascript:void(0);" class="add_to_wishlist" data-quantity="1" data-id="{{$nproducts->id}}" id="add_to_wishlist_{{$nproducts->id}}"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                            <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
                                                        </div>
                                                        <div class="product-action-2">
                                                            <a title="Add to cart"  href="#" data-quantity="1" data-product-id="{{$nproducts->id}} " class="add_to_cart" id="add_to_cart{{$nproducts->id}}">Add to cart</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.html">
                                                        ...
                                                        <img class="hover-img" src="Frontends/https://via.placeholder.com/550x750" alt="#">
                                                    </a>
                                                    <div class="button-head">
                                                        <div class="product-action">
                                                            <a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.html">
                                                        <img class="default-img" src="Frontends/Frontends/https://via.placeholder.com/550x750" alt="#">
                                                        <img class="hover-img" src="Frontends/https://via.placeholder.com/550x750" alt="#">
                                                    </a>
                                                    <div class="button-head">
                                                        <div class="product-action">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <div class="single-banner">
                    <img src="Frontends/https://via.placeholder.com/600x370" alt="#">
                    <div class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="list-image overlay">
                                <img src="Frontends/https://via.placeholder.com/115x140" alt="#">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="shop-single-blog">
                    <img src="Frontends/images/blog1.jpg" alt="#">						<div class="content">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="shop-single-blog">
                    ...
                    <img src="Frontends/images/blog2.jpg" alt="#">
                    <div class="content">
                        <p class="date">22 July, 2020. Monday</p>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <!-- Start Single Blog  -->
                <div class="shop-single-blog">
                    <img src="Frontends/images/blog3.jpg" alt="#">						<div class="content">
                        <p class="date">22 July, 2020. Monday</p>
                                ...
                                <div class="product-gallery">
                                    <div class="quickview-slider-active">
                                        <div class="single-slider">
                                            <img src="Frontends/https://via.placeholder.com/569x528" alt="#">
                                        </div>
                                        <div class="single-slider">
                                            <img src="Frontends/https://via.placeholder.com/569x528" alt="#">
                                        </div>
