        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-md-2 col-12">
                    <!-- Logo -->
                    <div class="logo">
                        <a href="{{route('home')}}"><img src="{{asset('Frontends/images/logo.png')}}" alt="logo"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                    <div class="search-top">
                        ...
                        <div class="search-top">
                            <form action="{{route('search')}}" method="GET">
                                @csrf
                                <input type="text" id="search_text" name="query" placeholder="Search here..." name="search">
                ...
                <div class="col-lg-2 col-md-3 col-12">
                    <div class="right-bar">
                        ...
                        <div class="sinlge-bar">
                            <a href="{{route('wishlist')}}" id="wishlist_counter"  class="wishlist-btn"><i class="fa fa-heart-o" aria-hidden="true"></i>{{\Gloudemans\Shoppingcart\Facades\Cart::instance('wishlist')->count()}}</a>
                        </div>
                        <div class="sinlge-bar">
                            <a href="#" class="single-icon"><i class="fa fa-user-circle-o" aria-hidden="true"></i></a>
                        </div>
                        <div class="sinlge-bar shopping">
                            <a href="#" class="single-icon"><i class="ti-bag"></i> <span class="cart_quantity">{{\Gloudemans\Shoppingcart\Facades\Cart::instance('shopping')->count()}}</span></a>
                            <!-- Shopping Item -->


                            <div class="shopping-item">
                                <div class="dropdown-cart-header">
                                    <span class="cart-counter">{{\Gloudemans\Shoppingcart\Facades\Cart::instance('shopping')->count()}}</span>
                                    <a href="#">View Cart</a>
                                </div>
                                ...
                                <div class="bottom">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a href="{{route('checkout1')}}" class="btn animate">Checkout</a>
                                ...
                                <li class="main-mega"><a href="#">best selling <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                    <ul class="mega-menu">
                                        <li class="single-menu">
                                            ...
                                            <div class="image">
                                                <img src="Frontends/https://via.placeholder.com/225x155" alt="#">
                                            </div>
