...
<!-- Title Tag  -->
<title>Xmarts - eCommerce HTML5 Template.</title>
<!-- Favicon -->
...
<!-- Magnific Popup -->
<link rel="stylesheet" href="{{asset('Frontends/css/magnific-popup.min.css')}}">
<!-- Font Awesome -->
<link rel="stylesheet" href="{{asset('Frontends/css/font-awesome.css')}}">
<!-- Fancybox -->
<link rel="stylesheet" href="css/jquery.fancybox.min.css')}}">
<!-- Themify Icons -->
<link rel="stylesheet" href="{{asset('Frontends/css/themify-icons.css')}}">
<!-- Nice Select CSS -->
<link rel="stylesheet" href="{{asset('Frontends/css/niceselect.css')}}">
<!-- Animate CSS -->
<link rel="stylesheet" href="{{asset('Frontends/css/animate.css')}}">
<!-- Flex Slider CSS -->
<link rel="stylesheet" href="{{asset('Frontends/css/flex-slider.min.css')}}">
<!-- Owl Carousel -->
<link rel="stylesheet" href="{{asset('Frontends/css/owl-carousel.css')}}">
<!-- Slicknav -->

<link rel="stylesheet" href="{{asset('Frontends/css/slicknav.min.css')}}">
